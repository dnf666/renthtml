        ...
        <el-collapse-transition>
          <div v-show="show3">
            <div class="transition-box">
              ...
              <span>最低：<el-input-number v-model="before" @change="handleChangeBefore" :min="0" :max="10000" label="最低"></el-input-number></span>
              <span>最高：<el-input-number v-model="after" @change="handleChangeAfter" :min="0" :max="10000" label="最高"></el-input-number></span>
